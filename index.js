const contentLetterSrart_actived = " Sắp đến sinh nhật tôi rồi đấy !!! " //Lời mở đầu cho bức thư
const mainContentLetter = "Nhớ tặng quà nhé !!!" //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src ="./img/banh.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/phao.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
